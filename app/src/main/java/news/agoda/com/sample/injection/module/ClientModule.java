...
public class ClientModule {
    ...
    public OkHttpClient provideOkHttpClient(HttpLoggingInterceptor loggingInterceptor,
                                            ...
                                            @Named("isDebug") boolean isDebug, Cache cache,
        ...
        OkHttpClient.Builder okHttpClient = new OkHttpClient.Builder().addNetworkInterceptor(
            cacheInterceptor)
    ...
    public Interceptor provideCacheInterceptor(@Named("cacheMaxAge") int maxAgeMin) {
        return chain -> {
            ...
            CacheControl cacheControl = new CacheControl.Builder().maxAge(maxAgeMin,
    ...
    public Interceptor provideOfflineCacheInterceptor(@Named("isConnect") boolean isConnect,
                                                      @Named("cacheMaxStale") int maxStaleDay) {
        return chain -> {
            Request request = chain.request();

            if (!isConnect) {
                CacheControl cacheControl = new CacheControl.Builder().maxStale(maxStaleDay,
                                                                                TimeUnit.DAYS)
                    .build();
